...
module GitHubChangelogGenerator
  describe Generator do
    ...
    def default_sections
      ['enhancements', 'bugs', 'breaking', 'issues']
    end
    ...
    describe "#parse_sections" do
      ...
      context 'valid json' do
        ...
        let (:sections_array) do
          [
            Section.new({ name: 'foo', prefix: 'foofix', labels: ['test1', 'test2'] }),
            Section.new({ name: 'bar', prefix: 'barfix', labels: ['test3', 'test4'] }),
          ]
        end
      ...
      context 'hash' do
        ...
        let(:sections_array) do
          [
            Section.new({ name: 'enhancements', prefix: '**Enhancements**', labels: ['feature', 'enhancement'] }),
